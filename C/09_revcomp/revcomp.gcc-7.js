...
(function() {
 ...
 var loadPackage = function(metadata) {
  ...
  var PACKAGE_NAME = "revcomp.gcc-7.data";
  var REMOTE_PACKAGE_BASE = "revcomp.gcc-7.data";
  ...
  function runWithFS() {
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_revcomp.gcc-7.data");
   }
   Module["addRunDependency"]("datafile_revcomp.gcc-7.data");
...
wasmBinaryFile = "revcomp.gcc-7.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("revcomp.gcc-7.worker.js");
